...
class Config:
    ...
    TELEGRAM_BOT_TOKEN = os.environ.get('TELEGRAM_BOT_TOKEN') or '7919647588:AAE21PYxU4bC08PmvfC_IFRU1p_FgpOkwGo'
    TELEGRAM_CHAT_ID = os.environ.get('TELEGRAM_CHAT_ID') or '5425768848'
